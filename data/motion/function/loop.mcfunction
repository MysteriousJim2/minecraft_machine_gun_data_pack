...
execute as @a[scores={smg_rightclick=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",components:{"minecraft:custom_data":{UnAliver:1b}}}},nbt={Inventory:[{id:"minecraft:arrow",components:{"minecraft:custom_data":{"bullet":true}}}]}] at @s rotated as @s anchored eyes run function motion:bullet_throw
